...
export class InfoPageComponent {
  ...
  public items: string[][] = [
    ['Leche de almendras ó soya: 1 taza', 'Leche light: 1 taza', 'Queso cottage: 3 cda', 'Yogurt bebible light natural: 250 ml', 'Yogurt griego natural: ¾'],
    ['* Melón: 1 taza', '* Piña: ¾ taza', '* Plátano: ½ pieza', '* Sandía: 1 taza', '* Ciruela Fresca: 2 piezas', '* Durazno Fresco: 2 piezas', '* Fresas: 1 taza', '* Frutas Varias: 1 taza', '* Guayaba: 3 piezas', '* Manzanas: 1 pieza', '* Moras: ¾ taza', '* Naranja: 1 pieza', '* Papaya: 1 taza', '* Pasas: 10 piezas', '* Peras: ½ pieza', '* Toronja: 1 pieza', '* Uvas: 18 piezas'],
